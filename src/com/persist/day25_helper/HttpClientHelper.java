...
public class HttpClientHelper {
	...
	/**
	 * 作用：实现网络访问文件，先给服务器�?�过“GET”方式提交数据，再返回相应的数据
	 * 
	 * @param url
	 *            ：访问网络的url地址
	 * @param params
	 *            String url：访问url时，�??要传递给服务器的参数�??
	 ...
	 *            ：访问网络的url地址
	 * @param params
	 *            String url：访问url时，�??要传递给服务器的参数�?? 第二个参数为：List<NameValuePair>
	 * @return byte[]
	 */
	 ...
	 *            ：访问网络的url地址
	 * @param params
	 *            String url：访问url时，�??要传递给服务器的参数�?? Map<String , Object>
	 * @return byte[]
	 */
